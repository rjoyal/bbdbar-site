      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            {[
              { href: "https://www.instagram.com/bluebirdmobiledessertbar/", label: "Instagram", icon: (
              ...
              { href: "https://www.facebook.com/Bluebirdmobiledessertbar", label: "Facebook", icon: (
              ...
              { href: "mailto:shauna@bluebirdmobilebaking.com", label: "Email", icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67z"/><path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908z"/></svg>
              )},
              { href: "https://www.pinterest.com/bluebirdmobiledessertbar/", label: "Pinterest", icon: (
